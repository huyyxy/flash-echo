...
def test_minimind3_upload_checkpoint_dry_run_uses_cos_prefix() -> None:
    ...
    assert "models/checkpoints/minimind3-filler-male_white_collar-v1.0.2/best" in result.command
    assert "flash-echo/minimind3/v1.0.2/male_white_collar/checkpoint/best" in result.command
...
def test_qwen_download_deploy_dry_run_uses_cos_prefix() -> None:
    ...
    assert "models/deploy/qwen3_5_0_8b-filler-company-v1.0.2-onnx" in result.command
    assert "flash-echo/qwen3_5_0_8b/v1.0.2/company/deploy" in result.command
