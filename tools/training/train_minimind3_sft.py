"""Fine-tune MiniMind3 on filler-prefix SFT data.
...
def parse_args() -> argparse.Namespace:
    args = sft.parse_args(description="SFT fine-tune MiniMind3 for filler prefixes.")
...
def main() -> int:
    return sft.main(
        ...
        template_dependency_name="MiniMind3 chat template",
    )
